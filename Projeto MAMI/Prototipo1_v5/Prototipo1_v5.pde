...
///////TOTAL DE 54 VARIAVEIS//////
PFont age;
PImage capa, c1, c2, c3, aviao, aviao_e, aviao_r,  imgGas, hudgas,brasao;
PImage heliD, heliE, jetD, jetE,shipD,shipE;
...
int tela, personagem1, personagem2,personagem3;
...
void setup() {
  ...
  brasao=loadImage("brasao.png");
  
  heliD=loadImage("heliD.png");
  heliE=loadImage("heliE.png");
  jetD=loadImage("jetD.png");
  jetE=loadImage("jetE.png");
  shipD=loadImage("shipD.png");
  shipE=loadImage("shipE.png");
